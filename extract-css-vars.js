...
function extractAllCSSVariables() {
    ...
    const selectors = ['f-page-header', 'f-navigation-menu', 'f-button', '.f-page-layout'];
    ...
    console.log(':root {');
    sortedVars.filter(v => v.includes('background') || v.includes('color')).forEach(v => {
        console.log(`    ${v}: var(--my-custom-value);`);
    });
    console.log('}');
